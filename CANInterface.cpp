...
void CANInterface::batteryTemp(byte data[8]){
	...
	cout<< "\tRaw Data (not reversed): "; // DELETE: for debugging
	for(int i = 0; i < 8; i++){ // DELETE: for debugging
		cout<< data[i] << "  "; // DELETE: for debugging
	} // DELETE: for debugging
	cout << endl; // DELETE: for debugging
	
	cout<< "\tRaw Data (reversed): "; // DELETE: for debugging
	for(int i = 0; i < 8; i++){ // DELETE: for debugging
		cout<< reverseData[i] << "  "; // DELETE: for debugging
	} // DELETE: for debugging
	cout << endl; // DELETE: for debugging
	
	cout<< "\tBattery Temp High Raw: "<<parse(32, 8, reverseData)<<", Final Data: " << highBatTemp << endl; // DELETE: for debugging
	cout<< "\tBattery Temp Low: " << parse(40, 8, reverseData)<<", Final Data: " <<lowBatTemp << endl << endl; // DELETE: for debugging
}
...
void CANInterface::highVolt(byte data[8]){
	...
	cout<< "\tHighVoltage Voltage Raw: " <<parse(56, 12, reverseData)<<", Final Data: "<<HVvolt << endl; // DELETE: for debugging
	cout<< "\tHighVoltage Current: " <<parse(40, 16, reverseData)<<", Final Data: "<< HVamp << endl; // DELETE: for debugging
	cout<< "\tHighVoltage Percent: " << parse(24, 8, reverseData)<<", Final Data: "<<HVpercent << endl << endl; // DELETE: for debugging
}
...
void CANInterface::twelveVolt(byte data[8]){
	...
	for (int i = 0; i < 7; i++){
		reverseData[i] = reverseBits(data[6 - i]);
	}
	dataLock.lock();
	twelvev = parse(16, 8, reverseData)*0.0784314; // twelve_volt
	dataLock.lock();
	...
	cout<< "\tTwelve Volt Voltage Raw: "<<parse(16, 8, reverseData) <<", Final Data: "<< twelvev << endl << endl; // DELETE: for debugging
}
...
void CANInterface::htank(byte data[8]){
	...
	cout<< "\tRaw Data:  "; // DELETE: for debugging
	for(int i = 0; i < 8; i++){ // DELETE: for debugging
		cout<< data[i] <<"  "; // DELETE: for debugging
	} // DELETE: for debugging
	cout<< endl; // DELETE: for debugging
	cout<< "\tTank 1 Temp Raw: " << parse(0, 10, data) << ", Final Data: " <<tank1Temp << endl; // DELETE: for debugging
	cout<< "\tTank 2 Temp Raw: " << parse(10, 10, data) << ", Final Data: "<< tank2Temp << endl; // DELETE: for debugging
	cout<< "\tTank 3 Temp Raw: " << parse(20, 10, data) << ", Final Data: "<< tank3Temp << endl; // DELETE: for debugging

	cout<< "\tTank 1 Pressure Raw: " << parse(30, 10, data) << ", Final Data: "<< tank1Pressure << endl; // DELETE: for debugging
	cout<< "\tTank 2 Pressure Raw: " << parse(40, 10, data) << ", Final Data: " << tank2Pressure << endl; // DELETE: for debugging
	cout<< "\tTank 3 Pressure Raw: " << parse(50, 10, data) << ", Final Data: "<< tank3Pressure << endl << endl; // DELETE: for debugging
}
